...
const App = () => {
  ...
  // Count the number of cameras the device has
  // const cameraCount = async () => {
  //   let cameraCountInternal = 0;
  ...
  //       cameraCountInternal = cameraCountInternal + 1;
  //     } );
  //     return cameraCountInternal
  //   } catch( err ) {
  //     // Handle Error
  //   };
  // }
